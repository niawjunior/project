<html>
    ...
    $result = mysqli_query($connect,"SELECT date,time,level FROM water_table WHERE place='$showh1' and date BETWEEN '$START_DATE' AND '$CURRENT_DATE'and time = '06:00' order by ID DESC LIMIT 7");
