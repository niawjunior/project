...
<body>
  ...
  ?>
<div align="right">
<button class="btn btn-primary btn-md" id="myBtn"><span class="glyphicon glyphicon-plus-sign"></span> เพิ่ม</button>
</div>
<br>
    ...
    <table class="table table-hover  "  border="0">
      <tr>
        <thead class="thead-inverse">
          ...
          <th class="default" width="15%" height="50"> <div align="center">ไฟล์ประกอบ (PDF)</div></th>
      ...
      while($objResult = mysqli_fetch_array($objQuery))
      {
        ...
        if($objResult["ID"] == $_GET["ID"] and $_GET["Action"] == "Edit")
        {
          ...
          <tr>
            ...
            <td><center><button name="btnAdd" class="btn btn-warning" type="" id="btnCancel" value="" OnClick="window.location='<?php echo $_SERVER["PHP_SELF"];?>?Page=<?php echo $Page?>';">ยกเลิก <span class="glyphicon glyphicon-share-alt"></span></button></center></td>
      ...
      <div class="modal-body" >
        <form role="form">
          <div class="form-group">
            <label for="usrname"><span class=""></span> เรื่อง/ข่าวสาร</label>
            <input type="text" class="form-control" id="txtt2" name="txtt2" placeholder="ชื่อเรื่อง" required>
          </div>
          <div class="form-group">
            <label for="psw"><span class=""></span> ไฟล์ประกอบ (PDF)</label>
            <input type="file" class="form-control" name="fileupload" id="fileupload" placeholder="เลือกไฟล์" required>
          </div>
          <div class="form-group">
            <label for="psw"><span class=""></span> วันที่</label>
            <input type="date" class="form-control" name="txtdate" id="txtdate" placeholder="" required>
          </div>
            <button type="submit" name="submit" id="submit" class="btn btn-primary btn-block" ><span class="glyphicon glyphicon-ok-sign"></span> บันทึก</button>
        </form>
      </div>
  </div>
</div> 
