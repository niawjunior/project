	...
	function Wave() {
		...
		/** Wave settings */
		var DENSITY = .75;
		var FRICTION = 1.25;	// strength of wave (height)
		...
		var DETAIL = Math.round( WIDTH / 30 ); // The number of particles used to build up the wave
		var WATER_DENSITY = 1.07;
		var AIR_DENSITY = 1.02;
		var TWITCH_INTERVAL = 5000; // The interval between random impulses being inserted into the wave to keep it moving
